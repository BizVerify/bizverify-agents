...
def _make_tool(schema: ToolSchema, client: BizVerifyClient) -> BaseTool:
    """Create a LangChain BaseTool subclass for a given ToolSchema."""
    ...
    class DynamicTool(BaseTool):
        ...
        def _run(self, **kwargs: Any) -> str:
            # Filter out None values for optional params not provided
...
class BizVerifyTools:
    """Factory for LangChain-compatible BizVerify tools."""
    ...
    def get_tools(self) -> list[BaseTool]:
        """Return all 9 BizVerify tools as LangChain BaseTool instances."""
